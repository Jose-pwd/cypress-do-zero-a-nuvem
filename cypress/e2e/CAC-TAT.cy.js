describe('Central de Atendimento ao Cliente TAT', function() { 
  ...
  it('preenche os campos obrigatórios e envia o formulário.', function() {
    ...
    cy.get('[name="firstName"]').type('José')
    cy.get('[name="lastName"]').type('Machado')
    cy.get(':nth-child(2) > :nth-child(1) > [name="email"]').type('josecontato18@hotmail.com')
  ...
  it('seleciona um arquivo utilizando uma fixture para a qual foi dada um alias', function() {
    ...
    it('preenche o campo da area de texto usando o comando invoke', function() {
